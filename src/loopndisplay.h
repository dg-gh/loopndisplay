...
namespace lnd
{
    ...
    protected:
        ...
        inline bool key_alt() const noexcept { return (glfwGetKey(lnd::__window_ptr, GLFW_KEY_LEFT_ALT) == GLFW_PRESS) || (glfwGetKey(lnd::__window_ptr, GLFW_KEY_RIGHT_ALT) == GLFW_PRESS); }
        inline bool key_shift() const noexcept { return (glfwGetKey(lnd::__window_ptr, GLFW_KEY_LEFT_SHIFT) == GLFW_PRESS) || (glfwGetKey(lnd::__window_ptr, GLFW_KEY_RIGHT_SHIFT) == GLFW_PRESS); }
