...
namespace lnd
{
	...
	public:
		...
		inline void reset_key_events()
		{
			...
			mouse_1_press.store(false);
			mouse_2_press.store(false);
			mouse_3_press.store(false);
			mouse_4_press.store(false);
			mouse_5_press.store(false);
			mouse_6_press.store(false);
			mouse_7_press.store(false);
			mouse_8_press.store(false);

			space_press.store(false);
			apostrophe_press.store(false);
			comma_press.store(false);
			minus_press.store(false);
			period_press.store(false);
			slash_press.store(false);
			...
			num0_press.store(false);
			num1_press.store(false);
			num2_press.store(false);
			num3_press.store(false);
			num4_press.store(false);
			num5_press.store(false);
			num6_press.store(false);
			num7_press.store(false);
			num8_press.store(false);
			num9_press.store(false);

			numpad0_press.store(false);
			numpad1_press.store(false);
			numpad2_press.store(false);
			numpad3_press.store(false);
			numpad4_press.store(false);
			numpad5_press.store(false);
			numpad6_press.store(false);
			numpad7_press.store(false);
			numpad8_press.store(false);
			numpad9_press.store(false);

			add_press.store(false);
			sub_press.store(false);
			mul_press.store(false);
			div_press.store(false);

			f1_press.store(false);
			f2_press.store(false);
			f3_press.store(false);
			f4_press.store(false);
			f5_press.store(false);
			f6_press.store(false);
			f7_press.store(false);
			f8_press.store(false);
			f9_press.store(false);
			f10_press.store(false);
			f11_press.store(false);
			f12_press.store(false);

			escape_press.store(false);
			enter_press.store(false);
			tab_press.store(false);
			backspace_press.store(false);
			insert_press.store(false);
			delete__press.store(false);
			right_press.store(false);
			left_press.store(false);
			down_press.store(false);
			up_press.store(false);
			alt_press.store(false);
			shift_press.store(false);

			// event release

			mouse_1_release.store(false);
			mouse_2_release.store(false);
			mouse_3_release.store(false);
			mouse_4_release.store(false);
			mouse_5_release.store(false);
			mouse_6_release.store(false);
			mouse_7_release.store(false);
			mouse_8_release.store(false);

			space_release.store(false);
			apostrophe_release.store(false);
			comma_release.store(false);
			minus_release.store(false);
			period_release.store(false);
			slash_release.store(false);

			A_release.store(false);
			B_release.store(false);
			C_release.store(false);
			D_release.store(false);
			E_release.store(false);
			F_release.store(false);
			G_release.store(false);
			H_release.store(false);
			I_release.store(false);
			J_release.store(false);
			K_release.store(false);
			L_release.store(false);
			M_release.store(false);
			N_release.store(false);
			O_release.store(false);
			P_release.store(false);
			Q_release.store(false);
			R_release.store(false);
			S_release.store(false);
			T_release.store(false);
			U_release.store(false);
			V_release.store(false);
			W_release.store(false);
			X_release.store(false);
			Y_release.store(false);
			Z_release.store(false);

			num0_release.store(false);
			num1_release.store(false);
			num2_release.store(false);
			num3_release.store(false);
			num4_release.store(false);
			num5_release.store(false);
			num6_release.store(false);
			num7_release.store(false);
			num8_release.store(false);
			num9_release.store(false);

			numpad0_release.store(false);
			numpad1_release.store(false);
			numpad2_release.store(false);
			numpad3_release.store(false);
			numpad4_release.store(false);
			numpad5_release.store(false);
			numpad6_release.store(false);
			numpad7_release.store(false);
			numpad8_release.store(false);
			numpad9_release.store(false);

			add_release.store(false);
			sub_release.store(false);
			mul_release.store(false);
			div_release.store(false);

			f1_release.store(false);
			f2_release.store(false);
			f3_release.store(false);
			f4_release.store(false);
			f5_release.store(false);
			f6_release.store(false);
			f7_release.store(false);
			f8_release.store(false);
			f9_release.store(false);
			f10_release.store(false);
			f11_release.store(false);
			f12_release.store(false);

			escape_release.store(false);
			enter_release.store(false);
			tab_release.store(false);
			backspace_release.store(false);
			insert_release.store(false);
			delete__release.store(false);
			right_release.store(false);
			left_release.store(false);
			down_release.store(false);
			up_release.store(false);
			alt_release.store(false);
			shift_release.store(false);
		}
	};
