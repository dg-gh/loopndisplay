...
namespace lnd
{
	...
	public:
		...
		bool mouse_1_press = false;
		bool mouse_2_press = false;
		bool mouse_3_press = false;
		bool mouse_4_press = false;
		bool mouse_5_press = false;
		bool mouse_6_press = false;
		bool mouse_7_press = false;
		bool mouse_8_press = false;

		bool space_press = false;
		bool apostrophe_press = false;
		bool comma_press = false;
		bool minus_press = false;
		bool period_press = false;
		bool slash_press = false;
		...
		bool num0_press = false;
		bool num1_press = false;
		bool num2_press = false;
		bool num3_press = false;
		bool num4_press = false;
		bool num5_press = false;
		bool num6_press = false;
		bool num7_press = false;
		bool num8_press = false;
		bool num9_press = false;

		bool numpad0_press = false;
		bool numpad1_press = false;
		bool numpad2_press = false;
		bool numpad3_press = false;
		bool numpad4_press = false;
		bool numpad5_press = false;
		bool numpad6_press = false;
		bool numpad7_press = false;
		bool numpad8_press = false;
		bool numpad9_press = false;

		bool add_press = false;
		bool sub_press = false;
		bool mul_press = false;
		bool div_press = false;
		...
		bool f8_press = false;
		bool f9_press = false;
		bool f10_press = false;
		bool f11_press = false;
		bool f12_press = false;

		bool escape_press = false;
		bool enter_press = false;
		bool tab_press = false;
		bool backspace_press = false;
		bool insert_press = false;
		bool delete__press = false;
		...
		bool mouse_1_release = false;
		bool mouse_2_release = false;
		bool mouse_3_release = false;
		bool mouse_4_release = false;
		bool mouse_5_release = false;
		bool mouse_6_release = false;
		bool mouse_7_release = false;
		bool mouse_8_release = false;

		bool space_release = false;
		bool apostrophe_release = false;
		bool comma_release = false;
		bool minus_release = false;
		bool period_release = false;
		bool slash_release = false;

		bool A_release = false;
		bool B_release = false;
		bool C_release = false;
		bool D_release = false;
		bool E_release = false;
		bool F_release = false;
		bool G_release = false;
		bool H_release = false;
		bool I_release = false;
		bool J_release = false;
		bool K_release = false;
		bool L_release = false;
		bool M_release = false;
		bool N_release = false;
		bool O_release = false;
		bool P_release = false;
		bool Q_release = false;
		bool R_release = false;
		bool S_release = false;
		bool T_release = false;
		bool U_release = false;
		bool V_release = false;
		bool W_release = false;
		bool X_release = false;
		bool Y_release = false;
		bool Z_release = false;

		bool num0_release = false;
		bool num1_release = false;
		bool num2_release = false;
		bool num3_release = false;
		bool num4_release = false;
		bool num5_release = false;
		bool num6_release = false;
		bool num7_release = false;
		bool num8_release = false;
		bool num9_release = false;

		bool numpad0_release = false;
		bool numpad1_release = false;
		bool numpad2_release = false;
		bool numpad3_release = false;
		bool numpad4_release = false;
		bool numpad5_release = false;
		bool numpad6_release = false;
		bool numpad7_release = false;
		bool numpad8_release = false;
		bool numpad9_release = false;

		bool add_release = false;
		bool sub_release = false;
		bool mul_release = false;
		bool div_release = false;

		bool f1_release = false;
		bool f2_release = false;
		bool f3_release = false;
		bool f4_release = false;
		bool f5_release = false;
		bool f6_release = false;
		bool f7_release = false;
		bool f8_release = false;
		bool f9_release = false;
		bool f10_release = false;
		bool f11_release = false;
		bool f12_release = false;

		bool escape_release = false;
		bool enter_release = false;
		bool tab_release = false;
		bool backspace_release = false;
		bool insert_release = false;
		bool delete__release = false;
		bool right_release = false;
		bool left_release = false;
		bool down_release = false;
		bool up_release = false;
		bool alt_release = false;
		bool shift_release = false;

		int padding_upper[8] = { 0 };

		inline void reset_key_events() { memset(this, 0, sizeof(lnd::user_key_input)); }
	};
	...
	void key_callback(GLFWwindow* window_ptr, int key, int scancode, int action, int mods)
	{
		...
		case GLFW_KEY_SPACE:
			lnd::__user_key_input.space_press = (action == GLFW_PRESS);
			lnd::__user_key_input.space_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_APOSTROPHE:
			lnd::__user_key_input.apostrophe_press = (action == GLFW_PRESS);
			lnd::__user_key_input.apostrophe_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_COMMA:
			lnd::__user_key_input.comma_press = (action == GLFW_PRESS);
			lnd::__user_key_input.comma_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_MINUS:
			lnd::__user_key_input.minus_press = (action == GLFW_PRESS);
			lnd::__user_key_input.minus_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_PERIOD:
			lnd::__user_key_input.period_press = (action == GLFW_PRESS);
			lnd::__user_key_input.period_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_SLASH:
			lnd::__user_key_input.slash_press = (action == GLFW_PRESS);
			lnd::__user_key_input.slash_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_A:
			lnd::__user_key_input.A_press = (action == GLFW_PRESS);
			lnd::__user_key_input.A_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_B:
			lnd::__user_key_input.B_press = (action == GLFW_PRESS);
			lnd::__user_key_input.B_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_C:
			lnd::__user_key_input.C_press = (action == GLFW_PRESS);
			lnd::__user_key_input.C_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_D:
			lnd::__user_key_input.D_press = (action == GLFW_PRESS);
			lnd::__user_key_input.D_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_E:
			lnd::__user_key_input.E_press = (action == GLFW_PRESS);
			lnd::__user_key_input.E_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F:
			lnd::__user_key_input.F_press = (action == GLFW_PRESS);
			lnd::__user_key_input.F_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_G:
			lnd::__user_key_input.G_press = (action == GLFW_PRESS);
			lnd::__user_key_input.G_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_H:
			lnd::__user_key_input.H_press = (action == GLFW_PRESS);
			lnd::__user_key_input.H_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_I:
			lnd::__user_key_input.I_press = (action == GLFW_PRESS);
			lnd::__user_key_input.I_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_J:
			lnd::__user_key_input.J_press = (action == GLFW_PRESS);
			lnd::__user_key_input.J_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_K:
			lnd::__user_key_input.K_press = (action == GLFW_PRESS);
			lnd::__user_key_input.K_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_L:
			lnd::__user_key_input.L_press = (action == GLFW_PRESS);
			lnd::__user_key_input.L_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_M:
			lnd::__user_key_input.M_press = (action == GLFW_PRESS);
			lnd::__user_key_input.M_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_N:
			lnd::__user_key_input.N_press = (action == GLFW_PRESS);
			lnd::__user_key_input.N_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_O:
			lnd::__user_key_input.O_press = (action == GLFW_PRESS);
			lnd::__user_key_input.O_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_P:
			lnd::__user_key_input.P_press = (action == GLFW_PRESS);
			lnd::__user_key_input.P_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_Q:
			lnd::__user_key_input.Q_press = (action == GLFW_PRESS);
			lnd::__user_key_input.Q_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_R:
			lnd::__user_key_input.R_press = (action == GLFW_PRESS);
			lnd::__user_key_input.R_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_S:
			lnd::__user_key_input.S_press = (action == GLFW_PRESS);
			lnd::__user_key_input.S_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_T:
			lnd::__user_key_input.T_press = (action == GLFW_PRESS);
			lnd::__user_key_input.T_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_U:
			lnd::__user_key_input.U_press = (action == GLFW_PRESS);
			lnd::__user_key_input.U_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_V:
			lnd::__user_key_input.V_press = (action == GLFW_PRESS);
			lnd::__user_key_input.V_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_W:
			lnd::__user_key_input.W_press = (action == GLFW_PRESS);
			lnd::__user_key_input.W_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_X:
			lnd::__user_key_input.X_press = (action == GLFW_PRESS);
			lnd::__user_key_input.X_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_Y:
			lnd::__user_key_input.Y_press = (action == GLFW_PRESS);
			lnd::__user_key_input.Y_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_Z:
			lnd::__user_key_input.Z_press = (action == GLFW_PRESS);
			lnd::__user_key_input.Z_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_0:
			lnd::__user_key_input.num0_press = (action == GLFW_PRESS);
			lnd::__user_key_input.num0_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_1:
			lnd::__user_key_input.num1_press = (action == GLFW_PRESS);
			lnd::__user_key_input.num1_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_2:
			lnd::__user_key_input.num2_press = (action == GLFW_PRESS);
			lnd::__user_key_input.num2_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_3:
			lnd::__user_key_input.num3_press = (action == GLFW_PRESS);
			lnd::__user_key_input.num3_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_4:
			lnd::__user_key_input.num4_press = (action == GLFW_PRESS);
			lnd::__user_key_input.num4_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_5:
			lnd::__user_key_input.num5_press = (action == GLFW_PRESS);
			lnd::__user_key_input.num5_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_6:
			lnd::__user_key_input.num6_press = (action == GLFW_PRESS);
			lnd::__user_key_input.num6_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_7:
			lnd::__user_key_input.num7_press = (action == GLFW_PRESS);
			lnd::__user_key_input.num7_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_8:
			lnd::__user_key_input.num8_press = (action == GLFW_PRESS);
			lnd::__user_key_input.num8_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_9:
			lnd::__user_key_input.num9_press = (action == GLFW_PRESS);
			lnd::__user_key_input.num9_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_0:
			lnd::__user_key_input.numpad0_press = (action == GLFW_PRESS);
			lnd::__user_key_input.numpad0_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_1:
			lnd::__user_key_input.numpad1_press = (action == GLFW_PRESS);
			lnd::__user_key_input.numpad1_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_2:
			lnd::__user_key_input.numpad2_press = (action == GLFW_PRESS);
			lnd::__user_key_input.numpad2_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_3:
			lnd::__user_key_input.numpad3_press = (action == GLFW_PRESS);
			lnd::__user_key_input.numpad3_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_4:
			lnd::__user_key_input.numpad4_press = (action == GLFW_PRESS);
			lnd::__user_key_input.numpad4_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_5:
			lnd::__user_key_input.numpad5_press = (action == GLFW_PRESS);
			lnd::__user_key_input.numpad5_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_6:
			lnd::__user_key_input.numpad6_press = (action == GLFW_PRESS);
			lnd::__user_key_input.numpad6_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_7:
			lnd::__user_key_input.numpad7_press = (action == GLFW_PRESS);
			lnd::__user_key_input.numpad7_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_8:
			lnd::__user_key_input.numpad8_press = (action == GLFW_PRESS);
			lnd::__user_key_input.numpad8_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_9:
			lnd::__user_key_input.numpad9_press = (action == GLFW_PRESS);
			lnd::__user_key_input.numpad9_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_ADD:
			lnd::__user_key_input.add_press = (action == GLFW_PRESS);
			lnd::__user_key_input.add_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_SUBTRACT:
			lnd::__user_key_input.sub_press = (action == GLFW_PRESS);
			lnd::__user_key_input.sub_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_MULTIPLY:
			lnd::__user_key_input.mul_press = (action == GLFW_PRESS);
			lnd::__user_key_input.mul_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_DIVIDE:
			lnd::__user_key_input.div_press = (action == GLFW_PRESS);
			lnd::__user_key_input.div_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_KP_ENTER:
			lnd::__user_key_input.enter_press = (action == GLFW_PRESS);
			lnd::__user_key_input.enter_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F1:
			lnd::__user_key_input.f1_press = (action == GLFW_PRESS);
			lnd::__user_key_input.f1_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F2:
			lnd::__user_key_input.f2_press = (action == GLFW_PRESS);
			lnd::__user_key_input.f2_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F3:
			lnd::__user_key_input.f3_press = (action == GLFW_PRESS);
			lnd::__user_key_input.f3_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F4:
			lnd::__user_key_input.f4_press = (action == GLFW_PRESS);
			lnd::__user_key_input.f4_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F5:
			lnd::__user_key_input.f5_press = (action == GLFW_PRESS);
			lnd::__user_key_input.f5_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F6:
			lnd::__user_key_input.f6_press = (action == GLFW_PRESS);
			lnd::__user_key_input.f6_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F7:
			lnd::__user_key_input.f7_press = (action == GLFW_PRESS);
			lnd::__user_key_input.f7_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F8:
			lnd::__user_key_input.f8_press = (action == GLFW_PRESS);
			lnd::__user_key_input.f8_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F9:
			lnd::__user_key_input.f9_press = (action == GLFW_PRESS);
			lnd::__user_key_input.f9_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F10:
			lnd::__user_key_input.f10_press = (action == GLFW_PRESS);
			lnd::__user_key_input.f10_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F11:
			lnd::__user_key_input.f11_press = (action == GLFW_PRESS);
			lnd::__user_key_input.f11_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_F12:
			lnd::__user_key_input.f12_press = (action == GLFW_PRESS);
			lnd::__user_key_input.f12_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_ESCAPE:
			lnd::__user_key_input.escape_press = (action == GLFW_PRESS);
			lnd::__user_key_input.escape_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_ENTER:
			lnd::__user_key_input.enter_press = (action == GLFW_PRESS);
			lnd::__user_key_input.enter_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_TAB:
			lnd::__user_key_input.tab_press = (action == GLFW_PRESS);
			lnd::__user_key_input.tab_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_BACKSPACE:
			lnd::__user_key_input.backspace_press = (action == GLFW_PRESS);
			lnd::__user_key_input.backspace_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_INSERT:
			lnd::__user_key_input.insert_press = (action == GLFW_PRESS);
			lnd::__user_key_input.insert_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_DELETE:
			lnd::__user_key_input.delete__press = (action == GLFW_PRESS);
			lnd::__user_key_input.delete__release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_RIGHT:
			lnd::__user_key_input.right_press = (action == GLFW_PRESS);
			lnd::__user_key_input.right_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_LEFT:
			lnd::__user_key_input.left_press = (action == GLFW_PRESS);
			lnd::__user_key_input.left_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_DOWN:
			lnd::__user_key_input.down_press = (action == GLFW_PRESS);
			lnd::__user_key_input.down_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_UP:
			lnd::__user_key_input.up_press = (action == GLFW_PRESS);
			lnd::__user_key_input.up_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_LEFT_ALT:
			lnd::__user_key_input.alt_press = (action == GLFW_PRESS);
			lnd::__user_key_input.alt_release = (action == GLFW_RELEASE);
			break;
		case GLFW_KEY_LEFT_SHIFT:
			lnd::__user_key_input.shift_press = (action == GLFW_PRESS);
			lnd::__user_key_input.shift_release = (action == GLFW_RELEASE);
			break;
	...
	void mouse_button_callback(GLFWwindow* window_ptr, int button, int action, int mods)
	{
		...
		case GLFW_MOUSE_BUTTON_1:
			lnd::__user_key_input.mouse_1_press = (action == GLFW_PRESS);
			lnd::__user_key_input.mouse_1_release = (action == GLFW_RELEASE);
			break;
		case GLFW_MOUSE_BUTTON_2:
			lnd::__user_key_input.mouse_2_press = (action == GLFW_PRESS);
			lnd::__user_key_input.mouse_2_release = (action == GLFW_RELEASE);
			break;
		case GLFW_MOUSE_BUTTON_3:
			lnd::__user_key_input.mouse_3_press = (action == GLFW_PRESS);
			lnd::__user_key_input.mouse_3_release = (action == GLFW_RELEASE);
			break;
		case GLFW_MOUSE_BUTTON_4:
			lnd::__user_key_input.mouse_4_press = (action == GLFW_PRESS);
			lnd::__user_key_input.mouse_4_release = (action == GLFW_RELEASE);
			break;
		case GLFW_MOUSE_BUTTON_5:
			lnd::__user_key_input.mouse_5_press = (action == GLFW_PRESS);
			lnd::__user_key_input.mouse_5_release = (action == GLFW_RELEASE);
			break;
		case GLFW_MOUSE_BUTTON_6:
			lnd::__user_key_input.mouse_6_press = (action == GLFW_PRESS);
			lnd::__user_key_input.mouse_6_release = (action == GLFW_RELEASE);
			break;
		case GLFW_MOUSE_BUTTON_7:
			lnd::__user_key_input.mouse_7_press = (action == GLFW_PRESS);
			lnd::__user_key_input.mouse_7_release = (action == GLFW_RELEASE);
			break;
		case GLFW_MOUSE_BUTTON_8:
			lnd::__user_key_input.mouse_8_press = (action == GLFW_PRESS);
			lnd::__user_key_input.mouse_8_release = (action == GLFW_RELEASE);
			break;
...
namespace lnd
{
	...
	protected:
		...
		inline bool mouse_1_press() const noexcept { return lnd::__user_key_input.mouse_1_press; }
		inline bool mouse_2_press() const noexcept { return lnd::__user_key_input.mouse_2_press; }
		inline bool mouse_3_press() const noexcept { return lnd::__user_key_input.mouse_3_press; }
		inline bool mouse_4_press() const noexcept { return lnd::__user_key_input.mouse_4_press; }
		inline bool mouse_5_press() const noexcept { return lnd::__user_key_input.mouse_5_press; }
		inline bool mouse_6_press() const noexcept { return lnd::__user_key_input.mouse_6_press; }
		inline bool mouse_7_press() const noexcept { return lnd::__user_key_input.mouse_7_press; }
		inline bool mouse_8_press() const noexcept { return lnd::__user_key_input.mouse_8_press; }

		inline bool key_space_press() const noexcept { return lnd::__user_key_input.space_press; }
		inline bool key_apostrophe_press() const noexcept { return lnd::__user_key_input.apostrophe_press; }
		inline bool key_comma_press() const noexcept { return lnd::__user_key_input.comma_press; }
		inline bool key_minus_press() const noexcept { return lnd::__user_key_input.minus_press; }
		inline bool key_period_press() const noexcept { return lnd::__user_key_input.period_press; }
		inline bool key_slash_press() const noexcept { return lnd::__user_key_input.slash_press; }

		inline bool key_A_press() const noexcept { return lnd::__user_key_input.A_press; }
		inline bool key_B_press() const noexcept { return lnd::__user_key_input.B_press; }
		inline bool key_C_press() const noexcept { return lnd::__user_key_input.C_press; }
		inline bool key_D_press() const noexcept { return lnd::__user_key_input.D_press; }
		inline bool key_E_press() const noexcept { return lnd::__user_key_input.E_press; }
		inline bool key_F_press() const noexcept { return lnd::__user_key_input.F_press; }
		inline bool key_G_press() const noexcept { return lnd::__user_key_input.G_press; }
		inline bool key_H_press() const noexcept { return lnd::__user_key_input.H_press; }
		inline bool key_I_press() const noexcept { return lnd::__user_key_input.I_press; }
		inline bool key_J_press() const noexcept { return lnd::__user_key_input.J_press; }
		inline bool key_K_press() const noexcept { return lnd::__user_key_input.K_press; }
		inline bool key_L_press() const noexcept { return lnd::__user_key_input.L_press; }
		inline bool key_M_press() const noexcept { return lnd::__user_key_input.M_press; }
		inline bool key_N_press() const noexcept { return lnd::__user_key_input.N_press; }
		inline bool key_O_press() const noexcept { return lnd::__user_key_input.O_press; }
		inline bool key_P_press() const noexcept { return lnd::__user_key_input.P_press; }
		inline bool key_Q_press() const noexcept { return lnd::__user_key_input.Q_press; }
		inline bool key_R_press() const noexcept { return lnd::__user_key_input.R_press; }
		inline bool key_S_press() const noexcept { return lnd::__user_key_input.S_press; }
		inline bool key_T_press() const noexcept { return lnd::__user_key_input.T_press; }
		inline bool key_U_press() const noexcept { return lnd::__user_key_input.U_press; }
		inline bool key_V_press() const noexcept { return lnd::__user_key_input.V_press; }
		inline bool key_W_press() const noexcept { return lnd::__user_key_input.W_press; }
		inline bool key_X_press() const noexcept { return lnd::__user_key_input.X_press; }
		inline bool key_Y_press() const noexcept { return lnd::__user_key_input.Y_press; }
		inline bool key_Z_press() const noexcept { return lnd::__user_key_input.Z_press; }

		inline bool key_0_press() const noexcept { return __user_key_input.num0_press; }
		inline bool key_1_press() const noexcept { return __user_key_input.num1_press; }
		inline bool key_2_press() const noexcept { return __user_key_input.num2_press; }
		inline bool key_3_press() const noexcept { return __user_key_input.num3_press; }
		inline bool key_4_press() const noexcept { return __user_key_input.num4_press; }
		inline bool key_5_press() const noexcept { return __user_key_input.num5_press; }
		inline bool key_6_press() const noexcept { return __user_key_input.num6_press; }
		inline bool key_7_press() const noexcept { return __user_key_input.num7_press; }
		inline bool key_8_press() const noexcept { return __user_key_input.num8_press; }
		inline bool key_9_press() const noexcept { return __user_key_input.num9_press; }

		inline bool key_pad0_press() const noexcept { return __user_key_input.numpad0_press; }
		inline bool key_pad1_press() const noexcept { return __user_key_input.numpad1_press; }
		inline bool key_pad2_press() const noexcept { return __user_key_input.numpad2_press; }
		inline bool key_pad3_press() const noexcept { return __user_key_input.numpad3_press; }
		inline bool key_pad4_press() const noexcept { return __user_key_input.numpad4_press; }
		inline bool key_pad5_press() const noexcept { return __user_key_input.numpad5_press; }
		inline bool key_pad6_press() const noexcept { return __user_key_input.numpad6_press; }
		inline bool key_pad7_press() const noexcept { return __user_key_input.numpad7_press; }
		inline bool key_pad8_press() const noexcept { return __user_key_input.numpad8_press; }
		inline bool key_pad9_press() const noexcept { return __user_key_input.numpad9_press; }

		inline bool key_add_press() const noexcept { return __user_key_input.add_press; }
		inline bool key_sub_press() const noexcept { return __user_key_input.sub_press; }
		inline bool key_mul_press() const noexcept { return __user_key_input.mul_press; }
		inline bool key_div_press() const noexcept { return __user_key_input.div_press; }

		inline bool key_F1_press() const noexcept { return __user_key_input.f1_press; }
		inline bool key_F2_press() const noexcept { return __user_key_input.f2_press; }
		inline bool key_F3_press() const noexcept { return __user_key_input.f3_press; }
		inline bool key_F4_press() const noexcept { return __user_key_input.f4_press; }
		inline bool key_F5_press() const noexcept { return __user_key_input.f5_press; }
		inline bool key_F6_press() const noexcept { return __user_key_input.f6_press; }
		inline bool key_F7_press() const noexcept { return __user_key_input.f7_press; }
		inline bool key_F8_press() const noexcept { return __user_key_input.f8_press; }
		inline bool key_F9_press() const noexcept { return __user_key_input.f9_press; }
		inline bool key_F10_press() const noexcept { return __user_key_input.f10_press; }
		inline bool key_F11_press() const noexcept { return __user_key_input.f11_press; }
		inline bool key_F12_press() const noexcept { return __user_key_input.f12_press; }

		inline bool key_escape_press() const noexcept { return __user_key_input.escape_press; }
		inline bool key_enter_press() const noexcept { return __user_key_input.enter_press; }
		inline bool key_tab_press() const noexcept { return __user_key_input.tab_press; }
		inline bool key_backspace_press() const noexcept { return __user_key_input.backspace_press; }
		inline bool key_insert_press() const noexcept { return __user_key_input.insert_press; }
		inline bool key_delete_press() const noexcept { return __user_key_input.delete__press; }
		inline bool key_right_press() const noexcept { return __user_key_input.right_press; }
		inline bool key_left_press() const noexcept { return __user_key_input.left_press; }
		inline bool key_down_press() const noexcept { return __user_key_input.down_press; }
		inline bool key_up_press() const noexcept { return __user_key_input.up_press; }
		inline bool key_alt_press() const noexcept { return __user_key_input.alt_press; }
		inline bool key_shift_press() const noexcept { return __user_key_input.shift_press; }


		inline bool mouse_1_release() const noexcept { return lnd::__user_key_input.mouse_1_release; }
		inline bool mouse_2_release() const noexcept { return lnd::__user_key_input.mouse_2_release; }
		inline bool mouse_3_release() const noexcept { return lnd::__user_key_input.mouse_3_release; }
		inline bool mouse_4_release() const noexcept { return lnd::__user_key_input.mouse_4_release; }
		inline bool mouse_5_release() const noexcept { return lnd::__user_key_input.mouse_5_release; }
		inline bool mouse_6_release() const noexcept { return lnd::__user_key_input.mouse_6_release; }
		inline bool mouse_7_release() const noexcept { return lnd::__user_key_input.mouse_7_release; }
		inline bool mouse_8_release() const noexcept { return lnd::__user_key_input.mouse_8_release; }

		inline bool key_space_release() const noexcept { return lnd::__user_key_input.space_release; }
		inline bool key_apostrophe_release() const noexcept { return lnd::__user_key_input.apostrophe_release; }
		inline bool key_comma_release() const noexcept { return lnd::__user_key_input.comma_release; }
		inline bool key_minus_release() const noexcept { return lnd::__user_key_input.minus_release; }
		inline bool key_period_release() const noexcept { return lnd::__user_key_input.period_release; }
		inline bool key_slash_release() const noexcept { return lnd::__user_key_input.slash_release; }

		inline bool key_A_release() const noexcept { return lnd::__user_key_input.A_release; }
		inline bool key_B_release() const noexcept { return lnd::__user_key_input.B_release; }
		inline bool key_C_release() const noexcept { return lnd::__user_key_input.C_release; }
		inline bool key_D_release() const noexcept { return lnd::__user_key_input.D_release; }
		inline bool key_E_release() const noexcept { return lnd::__user_key_input.E_release; }
		inline bool key_F_release() const noexcept { return lnd::__user_key_input.F_release; }
		inline bool key_G_release() const noexcept { return lnd::__user_key_input.G_release; }
		inline bool key_H_release() const noexcept { return lnd::__user_key_input.H_release; }
		inline bool key_I_release() const noexcept { return lnd::__user_key_input.I_release; }
		inline bool key_J_release() const noexcept { return lnd::__user_key_input.J_release; }
		inline bool key_K_release() const noexcept { return lnd::__user_key_input.K_release; }
		inline bool key_L_release() const noexcept { return lnd::__user_key_input.L_release; }
		inline bool key_M_release() const noexcept { return lnd::__user_key_input.M_release; }
		inline bool key_N_release() const noexcept { return lnd::__user_key_input.N_release; }
		inline bool key_O_release() const noexcept { return lnd::__user_key_input.O_release; }
		inline bool key_P_release() const noexcept { return lnd::__user_key_input.P_release; }
		inline bool key_Q_release() const noexcept { return lnd::__user_key_input.Q_release; }
		inline bool key_R_release() const noexcept { return lnd::__user_key_input.R_release; }
		inline bool key_S_release() const noexcept { return lnd::__user_key_input.S_release; }
		inline bool key_T_release() const noexcept { return lnd::__user_key_input.T_release; }
		inline bool key_U_release() const noexcept { return lnd::__user_key_input.U_release; }
		inline bool key_V_release() const noexcept { return lnd::__user_key_input.V_release; }
		inline bool key_W_release() const noexcept { return lnd::__user_key_input.W_release; }
		inline bool key_X_release() const noexcept { return lnd::__user_key_input.X_release; }
		inline bool key_Y_release() const noexcept { return lnd::__user_key_input.Y_release; }
		inline bool key_Z_release() const noexcept { return lnd::__user_key_input.Z_release; }

		inline bool key_0_release() const noexcept { return __user_key_input.num0_release; }
		inline bool key_1_release() const noexcept { return __user_key_input.num1_release; }
		inline bool key_2_release() const noexcept { return __user_key_input.num2_release; }
		inline bool key_3_release() const noexcept { return __user_key_input.num3_release; }
		inline bool key_4_release() const noexcept { return __user_key_input.num4_release; }
		inline bool key_5_release() const noexcept { return __user_key_input.num5_release; }
		inline bool key_6_release() const noexcept { return __user_key_input.num6_release; }
		inline bool key_7_release() const noexcept { return __user_key_input.num7_release; }
		inline bool key_8_release() const noexcept { return __user_key_input.num8_release; }
		inline bool key_9_release() const noexcept { return __user_key_input.num9_release; }

		inline bool key_pad0_release() const noexcept { return __user_key_input.numpad0_release; }
		inline bool key_pad1_release() const noexcept { return __user_key_input.numpad1_release; }
		inline bool key_pad2_release() const noexcept { return __user_key_input.numpad2_release; }
		inline bool key_pad3_release() const noexcept { return __user_key_input.numpad3_release; }
		inline bool key_pad4_release() const noexcept { return __user_key_input.numpad4_release; }
		inline bool key_pad5_release() const noexcept { return __user_key_input.numpad5_release; }
		inline bool key_pad6_release() const noexcept { return __user_key_input.numpad6_release; }
		inline bool key_pad7_release() const noexcept { return __user_key_input.numpad7_release; }
		inline bool key_pad8_release() const noexcept { return __user_key_input.numpad8_release; }
		inline bool key_pad9_release() const noexcept { return __user_key_input.numpad9_release; }

		inline bool key_add_release() const noexcept { return __user_key_input.add_release; }
		inline bool key_sub_release() const noexcept { return __user_key_input.sub_release; }
		inline bool key_mul_release() const noexcept { return __user_key_input.mul_release; }
		inline bool key_div_release() const noexcept { return __user_key_input.div_release; }

		inline bool key_F1_release() const noexcept { return __user_key_input.f1_release; }
		inline bool key_F2_release() const noexcept { return __user_key_input.f2_release; }
		inline bool key_F3_release() const noexcept { return __user_key_input.f3_release; }
		inline bool key_F4_release() const noexcept { return __user_key_input.f4_release; }
		inline bool key_F5_release() const noexcept { return __user_key_input.f5_release; }
		inline bool key_F6_release() const noexcept { return __user_key_input.f6_release; }
		inline bool key_F7_release() const noexcept { return __user_key_input.f7_release; }
		inline bool key_F8_release() const noexcept { return __user_key_input.f8_release; }
		inline bool key_F9_release() const noexcept { return __user_key_input.f9_release; }
		inline bool key_F10_release() const noexcept { return __user_key_input.f10_release; }
		inline bool key_F11_release() const noexcept { return __user_key_input.f11_release; }
		inline bool key_F12_release() const noexcept { return __user_key_input.f12_release; }

		inline bool key_escape_release() const noexcept { return __user_key_input.escape_release; }
		inline bool key_enter_release() const noexcept { return __user_key_input.enter_release; }
		inline bool key_tab_release() const noexcept { return __user_key_input.tab_release; }
		inline bool key_backspace_release() const noexcept { return __user_key_input.backspace_release; }
		inline bool key_insert_release() const noexcept { return __user_key_input.insert_release; }
		inline bool key_delete_release() const noexcept { return __user_key_input.delete__release; }
		inline bool key_right_release() const noexcept { return __user_key_input.right_release; }
		inline bool key_left_release() const noexcept { return __user_key_input.left_release; }
		inline bool key_down_release() const noexcept { return __user_key_input.down_release; }
		inline bool key_up_release() const noexcept { return __user_key_input.up_release; }
		inline bool key_alt_release() const noexcept { return __user_key_input.alt_release; }
		inline bool key_shift_release() const noexcept { return __user_key_input.shift_release; }
	...
	private:
			...
			bool rescale_screen_coordinates, const char* new_title)
		{
			...
			if (window_fullscreen) { lnd::__window_ptr = glfwCreateWindow(new_screen_width, new_screen_height, new_title, glfwGetPrimaryMonitor(), nullptr); }
			else { lnd::__window_ptr = glfwCreateWindow(new_screen_width, new_screen_height, new_title, nullptr, nullptr); }
